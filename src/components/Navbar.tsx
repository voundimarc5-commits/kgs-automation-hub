  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-xl border-b border-border">
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        <a href="/" onClick={(e) => { e.preventDefault(); navigate("/"); }} className="flex items-center gap-1.5">
          <img src={logo} alt="KGS Automations" className="h-14 md:h-16 animate-logo-pulse" />
          <div className="flex flex-col leading-none">
            <span className="text-sm md:text-base font-bold text-primary">Automations</span>
            <span className="text-[8px] md:text-[9px] text-muted-foreground">Kora Global Systems</span>
          </div>
        </a>
